...
from .views import  all_products, PaymentConfirmationView, RechercheProduitView,HistoriqueRechercheView,ProduitViews,CheckoutView,ConfirmOrderView, detail
...
urlpatterns = [
    ...
    path('<slug:super_categorie_slug>/', all_products, name='all_products'),
